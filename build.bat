...
ldc2 -c -betterC -I=src -mtriple=i386-none-elf -release -nodefaultlib --boundscheck=off --disable-red-zone --use-ctors=0 src/stdarg.d -of=o-elf-x86/stdarg.o
...
ld.lld -m elf_i386 -T linker.ld -o cdroot/kernel.bin o-elf-x86/start.s.o o-elf-x86/main.o o-elf-x86/core/gdt.o o-elf-x86/bootloader/multiboot.o o-elf-x86/port.s.o o-elf-x86/gdt.s.o o-elf-x86/core/stddef.o o-elf-x86/core/string.o o-elf-x86/core/vga.o o-elf-x86/core/framebuffer.o o-elf-x86/core/pit.o o-elf-x86/core/ps2.o o-elf-x86/core/keyboard.o o-elf-x86/logo.o o-elf-x86/cursor.o o-elf-x86/font.o o-elf-x86/console.o o-elf-x86/stdio.o o-elf-x86/error.o o-elf-x86/stdarg.o
