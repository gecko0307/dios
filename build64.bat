...
ld.lld -m elf_x86_64 -T linker64.ld -z max-page-size=0x1000 -static --gc-sections -nostdlib -o cdroot64/kernel64.bin o-elf-x86_64/main64.o o-elf-x86_64/bootloader/limine.o o-elf-x86_64/port64.s.o o-elf-x86_64/logo.o o-elf-x86_64/cursor.o
xorriso -as mkisofs -r -b limine/limine-bios-cd.bin -no-emul-boot -boot-load-size 4 -boot-info-table -eltorito-alt-boot -e limine/limine-uefi-cd.bin -no-emul-boot -isohybrid-gpt-basdat -o dios64.iso ./cdroot64
